...
void ws2812_fill(int R,int G,int B)
{
	...
	{
		ws2812_pixel_rgb_to_buf_dma(R , G, B, i);
	}
}
...
void ws2812_setValue(void)
{
  ...
  {
    ws2812_pixel_rgb_to_buf_dma( rgb_temp[0][0], rgb_temp[0][1], rgb_temp[0][2], n*4);
    ws2812_pixel_rgb_to_buf_dma( rgb_temp[1][0], rgb_temp[1][1], rgb_temp[1][2], n*4+1);
    ws2812_pixel_rgb_to_buf_dma( rgb_temp[2][0], rgb_temp[2][1], rgb_temp[2][2], n*4+2);
    ws2812_pixel_rgb_to_buf_dma( rgb_temp[3][0], rgb_temp[3][1], rgb_temp[3][2], n*4+3);
  }
}
//------------------------------------------------------------------
